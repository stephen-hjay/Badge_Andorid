...
//      mHandler = new Handler();
        ...
        Log.v("sysout","new on create");
    }// end of onCreate()

    //bluetooth positioning init
    ...
    //if a click on some button-- click listener // completely not used  controlled by binding in UI
    @Override
    public void onClick(View v) {
        Log.v("sysout","start click");
        switch (v.getId()) {
            case R.id.start_btn://click on start button
                Log.v("sysout","start Clicked");
                //change startButton to stopButton
                startBtn.setVisibility(View.INVISIBLE);
                stopBtn.setVisibility(View.VISIBLE);

                recordingThread = new RecordingThread();// start a new thread ??
                recordingThread.start();

                break;

            case R.id.stop_btn:  // click on stop button
                startBtn.setVisibility(View.VISIBLE);// show start, hide stop
            ...
            case R.id.saoyisao: //scan bar code button
...
//        mBluetoothPositionReader.open();//causing the app crash
...
//        mBluetoothPositionReader.close();//causing the APP crash
